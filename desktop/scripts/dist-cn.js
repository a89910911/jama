...
console.log('  完整版安装包：JamaAI Setup x.x.x.exe');
console.log('  完整版便携版：JamaAI x.x.x.exe');
console.log('  纯净版安装包：JamaAI-Lite-Setup-x.x.x.exe');
console.log('  纯净版便携版：JamaAI-Lite-x.x.x.exe\n');
process.exit(0);
