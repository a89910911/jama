...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版（Intel）：JamaAI-x.x.x-mac-x64.dmg"
echo "  完整版（ARM）  ：JamaAI-x.x.x-mac-arm64.dmg"
echo "  纯净版（Intel）：JamaAI-Lite-x.x.x-mac-x64.dmg"
echo "  纯净版（ARM）  ：JamaAI-Lite-x.x.x-mac-arm64.dmg"
echo ""
