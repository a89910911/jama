...
function imageRowToItem(row) {
  return {
    ...
    character_look_id: row.character_look_id ?? undefined,
    character_look_revision: row.character_look_revision ?? undefined,
    parent_generation_id: row.parent_generation_id ?? undefined,
    provider: row.provider,
    prompt: row.prompt,
    model: row.model,
    provider_url: row.provider_url ?? undefined,
    image_url: row.image_url,
    local_path: row.local_path,
    localize_status: row.localize_status ?? undefined,
    localize_error: row.localize_error ?? undefined,
    localized_at: row.localized_at ?? undefined,
    status: row.status,
    task_id: row.task_id,
